...
#define VESC_CURRENT_BASE				VESC_BASE
#define VESC_CURRENT_MANIP_GRIP			(VESC_CURRENT_BASE + 9)
#define VESC_CURRENT_MANIP_STAMP		(VESC_CURRENT_BASE + 10)
#define VESC_CURRENT_MANIP_RULL			(VESC_CURRENT_BASE + 11)
#define VESC_CURRENT_MANIP_TELE			(VESC_CURRENT_BASE + 12)
